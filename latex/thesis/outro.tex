...
For the sake of the environment, no full source files are appended. However, all source files are available 
in a GitHub repository. The access to that repository is available from the second supervisor: Max Schrötter.
%\endgroup
